...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
    ...
    const authorRole = "Zespół Redakcyjny";
    ...
    const articleJsonLd = {
        ...
        publisher: {
            ...
            logo: {
                "@type": "ImageObject",
                url: "https://strongbody.com.pl/images/logo.png",
            },
        },
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": `https://strongbody.com.pl/${resolvedParams.slug}`,
        },
    };
                    ...
                    <div className="text-white">
                        ...
                        <div className="flex items-center gap-6 text-sm font-medium">
                            <div className="flex items-center gap-2">
                                <Calendar size={16} />
                                {new Date(date).toLocaleDateString('pl-PL', { month: 'long', day: 'numeric', year: 'numeric' })}
                            </div>
                            <div className="flex items-center gap-2">
                                <Clock size={16} />
                                {author}
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <article className="lg:col-span-2">
                            ...
                            <div className="mt-8 pt-8 border-t border-grey-200">
                                <h3 className="text-lg font-bold text-grey-900 mb-4">Udostępnij ten artykuł</h3>
                        ...
                        <aside className="lg:col-span-1">
                            <div className="sticky top-24 space-y-8">
                                ...
                                {relatedPosts.filter((p: any) => p.slug !== resolvedParams.slug).length > 0 && (
                                    <div>
                                        <h3 className="text-xl font-bold text-grey-900 mb-6">Powiązane artykuły</h3>
                                                            ...
                                                            <div>
                                                                ...
                                                                {relatedPost.date && (
                                                                    <p className="text-xs text-grey-500 font-medium">
                                                                        {new Date(relatedPost.date).toLocaleDateString('pl-PL', { month: 'short', day: 'numeric' })}
                                                                    </p>
                                                                )}
                                                            </div>
                                                        </div>
                                ...
                                <div className="p-8 bg-gradient-to-br from-secondary to-grey-900 rounded-[2rem] relative overflow-hidden group shadow-xl shadow-secondary/20">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        >
                                            Zarezerwuj teraz <ArrowRight size={16} />
                                        </Link>
                                    </div>
                                </div>
                            </div>
