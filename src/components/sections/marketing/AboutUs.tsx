                ...
                <div className="grid lg:grid-cols-2 gap-10">
                    ...
                    <Reveal delay={0.2}>
                        <div className="p-8 rounded-3xl text-white h-full flex flex-col bg-secondary border border-grey-800 shadow-xl">
                            ...
                            <p className="text-sm font-bold text-white mb-6">Zyskujesz możliwość natychmiastowej globalizacji sprzedaży swoich usług:</p>
                            <ul className="space-y-4 mb-8 flex-1">
                                {[
                                    ...
                                    "Buduj silną markę osobistą poprzez Voice Hub – Twoją osobistą „stację radiową” automatycznie tłumaczoną na 40+ języków.",
