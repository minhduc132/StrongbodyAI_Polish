                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="p-10 md:p-14 rounded-3xl bg-white border border-grey-200 relative overflow-hidden group shadow-xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <span className="text-primary font-bold tracking-widest text-xs uppercase block mb-3">Dla Klientów</span>
                                <h3 className="text-2xl md:text-3xl font-bold text-text-p mb-4 leading-tight">
                                    Gotowy na rozmowę z globalnymi ekspertami we własnym języku?
                                </h3>
                                <p className="text-text-m font-medium mb-8 leading-relaxed">
                                    Znajdź zweryfikowanych profesjonalistów, porównaj opcje i rezerwuj z ufnością — wszystko na jednej platformie.
                                </p>
                                <Link
                                    href="/multime"
                                ...
                                >
                                    Pobierz aplikację MultiMe AI teraz <ArrowRight size={16} />
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="p-10 md:p-14 rounded-3xl bg-white border border-grey-200 relative overflow-hidden group shadow-xl">
                            ...
                            <div className="relative z-10">
                                ...
                                <span className="text-secondary font-bold tracking-widest text-xs uppercase block mb-3">Dla Profesjonalistów</span>
                                <h3 className="text-2xl md:text-3xl font-bold text-text-p mb-4 leading-tight">
                                    Jesteś licencjonowanym lekarzem, farmaceutą, specjalistą medycyny estetycznej lub ekspertem wellness?
                                </h3>
                                <p className="text-text-m font-medium mb-8 leading-relaxed">
                                    Dołącz do naszej selektywnej sieci zweryfikowanych specjalistów zdrowia i rozwijaj swoją praktykę globalnie.
                                </p>
                                <Link
                                ...
                                >
                                    Aplikuj jako Partner Strategiczny <ArrowRight size={16} />
                                </Link>
                            </div>
                        </div>
                    </div>
