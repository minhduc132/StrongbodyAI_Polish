...
const stats = [
    { icon: <ShieldCheck size={20} className="text-primary" />, val: "500+", label: "Zweryfikowani Profesjonaliści" },
    { icon: <Stethoscope size={20} className="text-primary" />, val: "20+", label: "Specjalizacje Medyczne" },
    { icon: <Map size={20} className="text-primary" />, val: "15", label: "Obsługiwane Stany" },
    { icon: <Activity size={20} className="text-primary" />, val: "98%", label: "Transakcje Bezsporne" },
];
                    ...
                    <div className="max-w-2xl px-2">
                        ...
                        <Reveal>
                            <p className="text-base text-grey-600 mb-10 leading-relaxed font-medium">
                                ...
                                • Wszystko w jednej darmowej aplikacji.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-10">
                                ...
                                >
                                    Pobierz Aplikację MultiMe AI <ArrowRight size={18} />
                                </Link>
                                <Link
                                    href="/blog"
                                    ...
                                    <Float delay={0.6}>
                                        <div className="bg-white/95 backdrop-blur shadow-xl py-3 px-5 rounded-2xl border border-grey-100 flex items-center gap-3 w-44 hover:translate-x-[-10px] transition-transform">
                                            ...
                                            <div className="leading-tight">
                                                ...
                                                <div className="text-[10px] font-bold text-grey-400">Zgodność</div>
                                            </div>
                                        </div>
                                    </Float>
                                    <Float delay={0.8}>
                                        <div className="bg-white/95 backdrop-blur shadow-xl py-3 px-5 rounded-2xl border border-grey-100 flex items-center gap-3 w-44 hover:translate-x-[-10px] transition-transform">
                                            ...
                                            <div className="leading-tight">
                                                ...
                                                <div className="text-[10px] font-bold text-grey-400">Chronione</div>
                                            </div>
                                        </div>
                                    </Float>
                                    <Float delay={1.0}>
                                        <div className="bg-white/95 backdrop-blur shadow-xl py-3 px-5 rounded-2xl border border-grey-100 flex items-center gap-3 w-44 hover:translate-x-[-10px] transition-transform">
                                            ...
                                            <div className="leading-tight">
                                                <div className="text-[13px] font-bold text-grey-900">Dopasowanie AI</div>
                                                <div className="text-[10px] font-bold text-grey-400">Włączone</div>
                                            </div>
                                        </div>
                                    </Float>
                                </div>
