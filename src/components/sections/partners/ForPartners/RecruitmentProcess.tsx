...
const RecruitmentProcess = () => {
    return (
        <section className="py-20 relative overflow-hidden" style={{ background: 'var(--brand-gradient)' }}>
            <Container>
                <span className="text-white font-bold tracking-widest text-xs uppercase mb-4 block">Proces</span>
                <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Proces rekrutacji partnerskiej</h2>
                <p className="text-white font-medium mb-10 max-w-2xl">
                    Nasz selektywny proces rekrutacji zapewnia, że każdy partner spełnia najwyższe standardy profesjonalizmu i zgodności.
                </p>
                ...
                <div className="mt-8 p-5 rounded-2xl bg-amber-50 border border-amber-100">
                    <p className="text-amber-800 font-bold text-sm">
                        StrongBody AI stosuje politykę selektywnej rekrutacji. Nie wszystkie zgłoszenia zostaną zaakceptowane.
                    </p>
                </div>
            </Container>
        </section>
