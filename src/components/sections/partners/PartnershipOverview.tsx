...
const eligibleProfessions = [
    "Licencjonowani lekarze medycyny",
    "Zarejestrowani farmaceuci",
    "Certyfikowani dermatolodzy, chirurdzy plastyczni, lekarze medycyny estetycznej",
    "Zarejestrowani dietetycy, lekarze medycyny stylu życia",
    "Certyfikowani trenerzy fitness, instruktorzy jogi, trenerzy wellness",
    "Licencjonowani psycholodzy, psychiatrzy, doradcy ds. zdrowia psychicznego",
    "Praktycy medycyny tradycyjnej, fizjoterapeuci, specjaliści rehabilitacji",
    "Właściciele akredytowanych klinik i centrów medycyny estetycznej"
];

const partnerBenefits = [
    "Dostęp do dziesiątek milionów klientów premium z USA, Wielkiej Brytanii, UE, Kanady, Australii…",
    "Twórz profesjonalne oferty bezpośrednio w MultiMe AI Chat (głos + tekst)",
    "Bezpieczne płatności Escrow – wypłacaj środki w 30 minut",
    "AI Voice Translate – klienci międzynarodowi rozumieją Cię natychmiastowo",
    "Buduj markę osobistą przez Voice Hub i blog",
    "Zatrzymaj 80% przychodów (tylko 20% opłaty platformowej)",
    "Optymalizacja profilu i wsparcie marketingowe od zespołu StrongBody AI"
];

const recruitmentProcess = [
    "Prześlij zgłoszenie zainteresowania",
    "Weryfikacja uprawnień i licencji",
    "Przegląd zgodności i regulacji",
    "Ocena profesjonalna / Rozmowa",
    "Strukturyzacja profilu cyfrowego",
    "Formalna aktywacja jako Partner Strategiczny"
];
            ...
            <Container className="relative z-10">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-text-m font-medium leading-relaxed max-w-2xl mx-auto">
                        Prowadzimy selektywną rekrutację licencjonowanych specjalistów zdrowia do naszej globalnej sieci.
                    </p>
                </div>
                    ...
                    <div>
                        <Reveal>
                            <h3 className="text-xl font-bold mb-6 flex items-center gap-2 text-text-p">
                                <Award className="text-primary" size={24} /> Idealne dla:
                            </h3>
                            ...
                            <div className="p-4 rounded-xl bg-primary-light border border-primary/10 text-primary text-sm font-bold mb-8">
                                Minimalne wymaganie: Musisz posiadać ważną licencję na wykonywanie zawodu w swojej jurysdykcji.
                            </div>
                        </Reveal>

                        <Reveal delay={0.1}>
                            <h3 className="text-xl font-bold mb-6 flex items-center gap-2 mt-12 text-text-p">
                                <ClipboardCheck className="text-primary" size={24} /> Proces rekrutacji
                            </h3>
                        ...
                        <Reveal delay={0.2} className="h-full">
                            <div className="p-8 md:p-10 rounded-[2.5rem] h-full flex flex-col bg-white border border-grey-300 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="relative z-10 flex-1 flex flex-col">
                                    <h3 className="text-2xl font-bold mb-8 text-text-p">Co zyskujesz jako Partner Strategiczny</h3>
                                    ...
                                    <div className="mt-auto">
                                        <p className="text-xs font-bold text-text-s uppercase tracking-widest mb-6">
                                            Polityka selektywnej rekrutacji – nie wszystkie zgłoszenia są akceptowane.
                                        </p>
                                        <Link
                                        ...
                                        >
                                            Aplikuj, aby zostać Partnerem Strategicznym <ArrowRight size={16} />
                                        </Link>
                                        <p className="text-xs text-text-m mt-4 font-medium text-center">
                                            Zajmuje 2 minuty • Poproś o pakiet partnerski • Umów się na konsultację
                                        </p>
                                    </div>
                                </div>
                            </div>
