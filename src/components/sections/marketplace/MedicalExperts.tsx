...
const experts = [
    {
        ...
        role: "Starszy Konsultant",
        description: "Ekspert w dziedzinie operacji klinicznych i zarządzania opieką zdrowotną z ponad 20-letnim doświadczeniem.",
        image: "https://images.unsplash.com/photo-1559839734-2b71f1536783?auto=format&fit=crop&q=80&w=400&h=400"
    },
    {
        name: "Kathy Yu-Syken",
        role: "Specjalista Pediatrii",
        description: "Znana z innowacyjnych modeli opieki i rodzinnych podejść pediatrycznych na całym świecie.",
    ...
    },
    {
        ...
        description: "Specjalizuje się w integracji klinicznej AI, koncentrując się na precyzji diagnostycznej i wynikach.",
