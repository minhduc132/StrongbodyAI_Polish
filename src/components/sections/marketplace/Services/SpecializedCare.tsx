                ...
                <div className="max-w-xl">
                    <Reveal>
                        <h3 className="text-2xl md:text-3xl font-bold text-text-p mb-4">
                            Odkryj opiekę specjalistyczną
                        </h3>
                    </Reveal>
                    <p className="text-text-m font-medium leading-relaxed">
                        Nasza sieć obejmuje szeroki zakres specjalistycznych kategorii medycznych i wellness,
                        z których każda została zweryfikowana pod kątem jakości i zgodności.
                    </p>
                </div>
            </div>
